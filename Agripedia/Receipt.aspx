pt<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/LoggedIn.Master" CodeBehind="Receipt.aspx.vb" Inherits="Agripedia.Receipt" %>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="text-center">
                                                ...
                                                <br />
                                                <br />
                                                Order Will be delivered to following address<br /><br />
